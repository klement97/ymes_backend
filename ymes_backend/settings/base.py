"""
Django settings for ymes_backend project.
...
SECRET_KEY = 'django-insecure-ae^^n6m$jm7psg4#c1c+p^hm=b!-%$n^@g=b+a&6lg7n%c7(_f'
...
WSGI_APPLICATION = 'ymes_backend.wsgi.application'
